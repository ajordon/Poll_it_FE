...
/***/ function(module, exports, __webpack_require__) {
	...
	var myApp = {
	  baseUrl: 'https://murmuring-anchorage-90095.herokuapp.com'
	};

	// data.polls[0].options.map(function(option){ return option.response; }); returns ["Batmand", "Superman"]
	var updateDataChart = function updateDataChart(poll) {
	  ...
	  var arr0 = [poll.options[0].response, op0VoteCount];
	  var arr1 = [poll.options[1].response, op1VoteCount];
	...
	var displayPollUrl = function displayPollUrl(data) {
	  $('.poll-link').innerHTML = myApp.baseUrl + "/polls/" + data.poll.id;
	};

	var showUserPolls = function showUserPolls(user) {
	  $.ajax({
	    url: myApp.baseUrl + '/polls?search_user=' + myApp.user.id,
	    method: 'GET',
	    dataType: 'json'
	  }).done(function (data) {
	...
	var pollsTemplate = function pollsTemplate(data) {
	  var polls = myApp.poll;
	  var pollListingTemplate = __webpack_require__(13);
	  $('.user-polls').html(pollListingTemplate({ polls: polls }));
	};

	//---------------------Webpage flow---------------------
	var createPollComplete = function createPollComplete(data) {
	  $('.intro').hide();
	  $('.poll-link').hide();
	  $('.poll-link').hide();
	...
	$(document).ready(function () {
	  ...
	  //-----------------------------------------
	  //--------------Create Poll Vote-----------
	  $('.create-poll-vote').on('click', function (e) {
	    e.preventDefault();
	    var formData = new FormData(e.target);
	    $.ajax({
	      url: myApp.baseUrl + '/polls/' + myApp.poll.id + '/votes',
	      method: 'POST',
	      headers: {
	        Authorization: 'Token token=' + myApp.user.token
	      },
	  ...
	  $('.user-polls').on('click', '.hb-view-poll', function (e) {
	    ...
	    $.ajax({
	      url: myApp.baseUrl + '/polls/' + myApp.viewpoll_id,
	      method: 'GET',
	      headers: {
	        Authorization: 'Token token=' + myApp.user.token
	      },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findPollComplete = function findPollComplete() {
	  $('#poll-search-bar').val('');
	...
	var signInComplete = function signInComplete() {
	  $('#myModal1').modal('hide');
	  $('.sign-in1').hide();
	  $('.sign-up1').hide();
	  $('.sign-out1').show();
	...
	var deletePollComplete = function deletePollComplete() {
	  $('.piechart').hide();
	  $('.intro').hide();
	...
	var updatePollComplete = function updatePollComplete() {
	  $('.piechart').show();
	  $('.intro').hide();
	};

	var signUpComplete = function signUpComplete() {
	  $('#myModal2').modal('hide');
	  $('.sign-up1').hide();
	  $('.change-password1').hide();
	  $('.sign-out1').hide();
	...
	var changePassComplete = function changePassComplete() {
	  console.log("Password changed");
	  $('#myModal3').modal('hide');
	};

	var signOutComplete = function signOutComplete() {
	  $('#myModal4').modal('hide');
	  $('.sign-in1').show();
	  $('.sign-up1').show();
	  $('.sign-out1').hide();
	...
	module.exports = {
	  findPollComplete: findPollComplete,
	  deletePollComplete: deletePollComplete,
	  updatePollComplete: updatePollComplete,
	  signUpComplete: signUpComplete,
	  changePassComplete: changePassComplete,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.polls : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "    <tr>"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"poll","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</tr>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "  <tr>No Polls for you.......yet</tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<tr>\n  <td>Id:</td>\n  <td>Question:</td>\n  <td>Total Votes: </td>\n</tr>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.polls : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"poll-row\">\n  <td>"
	    ...
	    + "</td>\n  <td>"
	    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.votes : depth0)) != null ? stack1.length : stack1), depth0))
	    + "</td>\n  <div class=\"each-polls col-md-6\" data="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n    <td><button class=\"btn btn-default hb-view-poll\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">View</button></td>\n    <td><button type=\"submit\" class=\"btn btn-default hb-update-poll\" data-control=\"hb-update-btn\" data-target=\"#updatePollModal\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\">Update</button></td>\n    <td><button type=\"submit\" class=\"btn btn-default hb-delete-poll\" data-control=\"hb-delete-btn\" data-target=\"#deletePollModal\" data-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
